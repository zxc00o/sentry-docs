...
When any of the following conditions occur for an issue, that issue is flagged *for review*, included in the **Review List**, and given a label indicating why it was flagged:
